export const portfolioData = [
  ...
  },
  {
    ...
    detail:
      "프로토타입 작업으로 프로젝트 수주부터 기획에도 참여한 프로젝트입니다. SVG를 활용하여 앱의 심플한 아이콘에 과하지 않은 생동감을 주었고, 담당 디자이너의 디테일한 지시에 맞추어 인터렉션의 미세한 부분까지 수정하여 브랜드 이미지에 맞는 고급스러운 움직임의 결과물을 만들었습니다.",
  ...
  },
  {
    ...
    detail:
      "반응형으로 작업한 첫 프로젝트입니다. Mobile First 규칙을 통해 css코드를 최소화 하는 방법으로 작업했습니다.",
  ...
  },
  {
    ...
    desc: "웹/모바일웹 사이트 신규 구축",
    detail:
      "첫 구축 프로젝트로, 도전적인 디자인을 퍼블리싱으로 구현해내는 데 약간의 어려움이 있었지만 원활하게 마무리 되었습니다.",
